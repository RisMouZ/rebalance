...
import { AutoFormObject } from "@/components/ui/auto-form-fields";
import type { Dependency, FieldConfig } from "@/components/ui/auto-form-types";
import {
  getDefaultValues,
  getObjectFormSchema,
...
export function AutoForm<SchemaType extends ZodObjectOrWrapped>({
  ...
  const defaultValues: DefaultValues<TObjectFormSchema> | null =
